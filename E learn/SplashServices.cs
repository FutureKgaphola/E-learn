...
namespace E_learn
{
    [Activity(Label = "GirlTech Connect", MainLauncher = true, ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait)]
    public class SplashServices : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            if(isGooglePlayServicesInstalled==true)
            {
                ...
                .WithFullScreen()
                .WithTargetActivity(Java.Lang.Class.FromType(typeof(Getstarted)))
                .WithSplashTimeOut(4000)
                .WithLogo(Resource.Mipmap.elearnsplash)
                .WithFooterText("GirlTech Connect\n\nDeveloped by GirlTech Connect est 2023")
